/***
* Name: TCPAvoidModelTrustv2
* Author: Lili
* Description: 
* Tags: Tag1, Tag2, TagN
***/

model TCPAvoidModelTrustv2
...
* Tags: 
* Changes:
* 	04/03/2021 - Add variables to save in csv, this with the purpose of create plots in python
*	04/03/2021 - Changed in indirect experience computing 
*/
...
global{
	...
	int 	peopleApp 			<- 500		category:'New simulation';
	...
	string scenario <- "Scenario_2_2_penalizacion_threshold_025_belief_01_weights";
...
species people skills:[moving] control: simple_bdi{
	...
	float 		speed 				<- 5 #km/#h;
	float   	belief_congestion	<- gauss(0.5,0.1);//rnd(0.5,1.0);
	...
	init
	{
		...
		openness				<-	rnd(0.0,1.0);
		conscientiousness		<-	rnd(0.0,1.0);
		extroversion			<-	rnd(0.0,1.0);
		agreeableness			<-	rnd(0.0,1.0);
		neurotism				<-	rnd(0.0,1.0);
